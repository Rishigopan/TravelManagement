        ...
        <div class="container mainContents">
            <div class="card card-body main_card mt-5 shadow-lg p-3 mb-5">
                <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                    <div>
                        <h3 class="pt-3">TICKET EXTEND REPORT</h3>
                    </div>
                    ...
                    <table class="table table-hover mastertable text-nowrap" id="MasterTable" style="width: 100%;">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="all">Passenger Name</th>
                                <th class="all">Old Date</th>
                                <th class="all">New Date</th>
                                <th class="all">Old Agency Rate</th>
                                <th class="all">New Agency Rate</th>
                                <th class="all">Old Customer Rate</th>
                                <th class="all">New Customer Rate</th>
                                <th class="none">Old AO NO.</th>
                                <th class="none">New AO NO.</th>
                            </tr>
                        </thead>
                        <tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            var MasterTable = $('#MasterTable').DataTable({
                "processing": true,
                "responsive": true,
                "ajax": "MasterDatas.php?TicketExtend",
                "scrollY": "600px",
                "scrollX": true,
                "scrollCollapse": true,
                "fixedHeader": true,
