...
<body>
        ...
        <div class="container mainContents mb-5">
            <div class="card card-body main_card shadow-lg p-3 mb-5">
                ...
                <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                    <div>
                        <h3 class="pt-3">DUMMY TICKET UPDATE</h3>
                    </div>
                </div>

                <form id="DummyUpdateTicketBookingForm" class="UpdateForm" novalidate>
                    ...
                    <div class="px-3 py-4">
                        <input class="form-control" name="DummyUpdateTicketId" type="text" value="<?= $ticketID; ?>" hidden>
                        <div class="row">
                            <div class="col-12">
                                <label class="TktcommonFont">Passenger Name</label>
                                <input type="text" class="form-control" name="DummyUpdateTicketPassenger" id="ticket_passenger" placeholder="Please type your fullname" value="<?= $FindBookingDetailResults['tPassenger']  ?>" required>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-5">
                                <label class="TktcommonFont">From</label>
                                <select class="form-select SelectFromCountry" name="DummyUpdateTicketFrom" id="ticket_from" aria-label="Default select example" required>
                            ...
                            <div class="col-5">
                                ...
                                <select class="form-select SelectToCountry" name="DummyUpdateTicketTo" id="ticket_to" aria-label="Default select example" required>
                        ...
                        <div class="row mt-2">
                            <div class="col-6">
                                ...
                                <input type="date" name="DummyUpdateTicketDeparture" value="<?= date('Y-m-d', strtotime($FindBookingDetailResults['tDeparture'])) ?>" id="ticket_departure" class="form-control" >
                            </div>
                            <div class="col-6">
                                <label class="TktcommonFont">Phone</label>
                                <input type="text" class="form-control" value="<?= $FindBookingDetailResults['tPhone']  ?>" name="DummyUpdateTicketPhone" id="ticket_phone" placeholder="Please enter your phoneno" >
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-6">
                                <label class="TktcommonFont">ID Proof</label>
                                <select class="form-select" name="DummyUpdateTicketProof" id="ticket_proof" aria-label="Default select example" >
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="DummyUpdateTicketProofNo" value="<?= $FindBookingDetailResults['tProofNo']  ?>" id="ticket_proof_no" class="form-control" placeholder="Enter your ID Proof No" >
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <label class="TktcommonFont">Care Of</label>
                                <select class="form-select SelectCustomer" name="DummyUpdateTicketCareof" id="passenger_careof" required>
                            ...
                            <div class="col-6">
                                ...
                                <input class="form-control" type="number" value="<?= $FindBookingDetailResults['tAoNumber'] ?>" name="DummyUpdateTicketAONumber" id="ticket_aonumber" >
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6" hidden>
                                <label for="ticket_status" class="TktcommonFont"> Status </label>
                                <select name="DummyUpdateTicketStatus" id="ticket_status" class="form-select ">
                        ...
                        if($Branch == 'TEZZA'){
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-select SelectAgency" name="DummyUpdateTicketBookingAgency" id="ticket_agency">
                                    <option hidden value="<?= $FindBookingDetailResults['AGENCYID'] ?>"> <?=  ($FindBookingDetailResults['AGENCYFIRST'] == null) ? "Choose Agency" :  $FindBookingDetailResults['AGENCYFIRST'] . ' ' . $FindBookingDetailResults['AGENCYLAST']  ?></option>
                                    <!-- <?php
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" name="DummyUpdateTicketAgencyRate" value="<?= $FindBookingDetailResults['tAgencyamount']  ?>" id="agency_rate" class="form-control" placeholder="&#8377;">
                            </div>
                            ...
                            <div class="col-6">
                                <label class="TktcommonFont">Agency</label>
                                <select class="form-select SelectAgency" name="DummyUpdateTicketBookingAgency" id="ticket_agency" required>
                                    <option hidden value="<?= $FindBookingDetailResults['AGENCYID'] ?>"> <?=  ($FindBookingDetailResults['AGENCYFIRST'] == null) ? "Choose Agency" :  $FindBookingDetailResults['AGENCYFIRST'] . ' ' . $FindBookingDetailResults['AGENCYLAST']  ?></option>
                                    <!-- <?php
                                            foreach ($FindAgency as $FindAgencyResults) {
                                                echo '
                            ...
                            <div class="col-6">
                                <label class="TktcommonFont">Agency Rate</label><br>
                                <input type="number" name="DummyUpdateTicketAgencyRate" value="<?= $FindBookingDetailResults['tAgencyamount']  ?>" id="agency_rate" class="form-control" placeholder="&#8377;" required>
                            </div>
                            <?php
                        }
                    ...
                    ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" name="DummyUpdateTicketAmount" value="<?= $FindBookingDetailResults['tAmount'] ?>" id="ticket_amount" class="form-control" placeholder="&#8377;" required>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(function() {
            ...
            let validator = $('#DummyUpdateTicketBookingForm').jbvalidator({
            ...
            $(document).on('submit', '#DummyUpdateTicketBookingForm', (function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#loading').hide();
                        console.log(data);
                        $('#DummyUpdateTicketBookingForm').removeClass("disable");
                        if (TestJson(data) == true) {
                            ...
                            if (response.UpdateTicketBooking == "0") {
                                ...
                                $('#confirmModal').modal('show');
                                ResetForms();
                                location.replace('DummyEnquiryReport.php');
