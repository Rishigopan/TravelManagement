...
<body>
    ...
    <div class="wrapper">
        ...
        if (isset($_GET['DTDAY'])) {
            $GivenDate = $_GET['DTDAY'];
            $fetchDayReport = mysqli_query($con, "SELECT dayStartupCapital,dayCashInHand FROM dayreport WHERE DATE(dayDate) = '$GivenDate'");
            if (mysqli_num_rows($fetchDayReport) > 0) {
                ...
                <div class="container-fluid mainContents px-5">
                    ...
                    <h4 class="text-center"> <strong>Day Report</strong> </h4>

                    <h6 class="text-center"> <strong> <?= $GivenDate ?> </strong> </h6>
                    ...
                    <div class="row" id="DayReportDetails">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="border border-1 mt-2 p-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-5 text-start">
                                        <h6 class="mt-2"> <strong><?= $StartUpCapital ?></strong> </h6>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-5 text-start">
                                        <h6 class="mt-2"> <strong><?= $CashInHand ?></strong> </h6>
                                    </div>
                                </div>
                            ...
                            <div class="border border-1 mt-2 p-2">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6">
                                        <h6 class="mt-2"> <strong>Added Profit</strong> </h6>
                                    </div>
                                    <div class="col-1 text-center">
                                        <h6 class="mt-2"> <strong>:</strong> </h6>
                                    </div>
                                    <div class="col-5 text-start">
                                        <h6 class="mt-2"> <strong> <?= $AddedProfit; ?> </strong> </h6>
                                    </div>
                                </div>
