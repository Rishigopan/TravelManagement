        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="text-center">Do you want to Delete this Dummy Enquiry?</h4>
        ...
        <div class="container mainContents">
            <div class="card card-body main_card mt-5 shadow-lg p-3 mb-5">
                <div class="main_heading d-flex justify-content-between mb-2 shadow p-2">
                    <div>
                        <h3 class="pt-3">DUMMY ENQUIRY REPORT </h3>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-6">
                                <select name="" class="form-select" id="FilterType">
                                    ...
                                    <option value="Dummy Normal">Normal</option>
                                    <option value="Dummy Group">Group</option>
                                </select>
                            </div>
                            <div class="col-lg-3 col-6">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#FilterCountry').change(function() {
                ...
                MasterTable.column().search(CountryFilter).draw();
            });
            ...
            var MasterTable = $('#MasterTable').DataTable({
                "processing": true,
                "responsive": true,
                "ajax": "DummyTicketReportData.php?DummyEnquiry",
                "scrollY": "600px",
                "scrollX": true,
                "scrollCollapse": true,
                "fixedHeader": true,
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row, meta) {
                            if (type == 'display') {
                                data = '<button class="btn rounded-pill btn-success px-3 text-dark btn_actions btn_book text-white text-center" data-bs-toggle="tooltip" data-bs-custom-class="cancel-tooltip" data-bs-placement="top" data-bs-title="Book Ticket" value="' + data.tbId + '"> Book </button>'
            ...
            //Book Ticket
            $('#MasterTable tbody').on('click', '.btn_book', function() {
                var BookValue = $(this).val();
                $.ajax({
                    type: "POST",
                    url: "MasterOperations.php",
                    data: {
                        DummyBookId: BookValue
                    },
                    beforeSend: function() {
                        $('#loading').show();
                        $('#ResponseImage').html("");
                    ...
                    success: function(data) {
                        ...
                        if (BookResponse.BookTicket == 0) {
                            $('#ResponseImage').html('<img src="./warning.jpg" style="height:130px;width:130px;" class="img-fluid" alt="">');
                            $('#ResponseText').text("Enquiry Already Exists");
                            $('#confirmModal').modal('show');
                        } else if (BookResponse.BookTicket == 1) {
                            ...
                            success: function(data) {
                                ...
                                if (TestJson(data) == true) {
                                    ...
                                    if (CancelReponse.CancelTicket == 0) {
                                        ...
                                        $('#ResponseImage').html('<img src="./success.jpg" style="height:130px;width:130px;" class="img-fluid" alt="">');
                                        $('#ResponseText').text("Successfully Deleted Enquiry");
                                        $('#confirmModal').modal('show');
                                        MasterTable.ajax.reload();
